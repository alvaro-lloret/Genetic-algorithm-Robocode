...
public class OptimalSuperTracker extends AdvancedRobot {
	
	Random randomGenerator; // AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAH HAS AÑADIDO ESTO ENUNCIADO
	 ...
	 */
	public void run() {
		randomGenerator = new Random(0);	//AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAH AÑADIDO ESTO
